	...
	**/
	...
	function ampExtension(options)
	{
		...
		var ampObj = 
		{
			...
			'Press the key <B>rightKey</B> if the Chinese symbol is more pleasant than average. ' + 
			'Hit the <b>leftKey</b> key if it is more unpleasant than average.<br/><br/>' + 
			...
			'Concentrate on each Chinese symbol and rate it as more "pleasant" than the average Chinese symbol with the <b>rightKey</b> key, ' + 
			'or more "unpleasant" than average with the <b>leftKey</b> key.<br/><br/>' + 
			...
			'Concentrate on the Chinese symbol and rate it as more "pleasant" than average with the <b>rightKey</b> key, ' + 
			'or more "unpleasant" than average with the <b>leftKey</b> key.<br/><br/>' + 
			'Evaluate each Chinese symbol and not the item that appears before it. ' + 
