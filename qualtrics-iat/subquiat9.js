    ...
    _.extend(piCurrent, _.defaults(options, iatObj));
        ...
        */
        ...
        API.addSettings('logger', {
            ...
            onRow: function(logName, log, settings, ctx){
							...
							var stimulus = log.stimulus;
							var category = log.category;
							var subcategory = null;
							if (category === 'category1') {
								if (stimulus === 'gs_zenbo.jpg' || stimulus === 'gs_mero.jpg' || stimulus === 'gs_int-ball.jpg' || stimulus === 'gs_speech buddy.jpg' || stimulus === 'gs_maggie.jpg' || stimulus === 'gs_papero.jpg' || stimulus === 'gs_irobi-q.jpg') {
									subcategory = 'aRobots';
								} else if (stimulus === 'gs_ethon2.jpg' || stimulus === 'gs_frankaemika.jpg' || stimulus === 'gs_homemate.jpg' || stimulus === 'gs_jibo.jpg' || stimulus === 'gs_mykie.jpg' || stimulus === 'gs_tellubee.jpg' || stimulus === 'gs_tjbot.jpg') {
									subcategory = 'mRobots';
								}
							}
							ctx.logs.push({
            ...
            // onEnd trigger save (by returning a value)
						onEnd: function(name, settings, ctx){
							...
							{
								var log = logs[iLog];
								if (log.stimuli[0] === 'gs_zenbo.jpg' || log.stimuli[0] === 'gs_mero.jpg' || log.stimuli[0] === 'gs_int-ball.jpg' || log.stimuli[0] === 'gs_speech buddy.jpg' || log.stimuli[0] === 'gs_maggie.jpg' || log.stimuli[0] === 'gs_papero.jpg' || log.stimuli[0] === 'gs_irobi-q.jpg') {
									log.subcategory = 'aRobots';
								} else if (log.stimuli[0] === 'gs_ethon2.jpg' || log.stimuli[0] === 'gs_frankaemika.jpg' || log.stimuli[0] === 'gs_homemate.jpg' || log.stimuli[0] === 'gs_jibo.jpg' || log.stimuli[0] === 'gs_mykie.jpg' || log.stimuli[0] === 'gs_tellubee.jpg' || log.stimuli[0] === 'gs_tjbot.jpg') {
									log.subcategory = 'mRobots';
								}
							}
							return logs;
						},
            ...
            serialize: function (name, logs) {
                var headers = ['block', 'trial', 'cond', 'comp', 'type', 'cat',  'stim', 'resp', 'err', 'rt', 'd', 'fb', 'bOrd', 'subcategory'];
                //console.log(logs);
                var myLogs = [];
                var iLog;
                for (iLog = 0; iLog < logs.length; iLog++)
		...
		*/
		...
		{//params: side is left or right. stimSet is the name of the stimulus set.
			...
			if (params.stimSet === 'category1') {
				set[0].stimuli[0].subcategory = params.subcategory;
			}
			return set;
		}
