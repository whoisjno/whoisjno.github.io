	...
	**/
	...
	function epExtension(options)
	{
		...
		var epObj =
		{
			...
			instructions : {
				//Block 1
				firstBlock : '<div><p style="font-size:16px; text-align:left; margin-left:10px; font-family:arial"><color="000000"><br/>' + 
				...
				//Block 2
				middleBlock : '<div><p style="font-size:16px; text-align:left; margin-left:10px; font-family:arial"><color="000000"><br/>' + 
				...
				//Block 3
				lastBlock : '<div><p style="font-size:16px; text-align:left; margin-left:10px; font-family:arial"><color="000000"><br/>' + 
		...
		API.addSettings('logger',{
			pulse: 20,
			url : '/implicit/PiPlayerApplet' //That is the url for send data to project implicit. Change this for other systems.
		});
				...
				interactions: [
					...
					},
					{
						...
						actions: [
							...
							{type:'removeInput',handle:[targetCats.leftAttTargets.name,targetCats.rightAttTargets.name, 'targetOut']},
					...
					// Handle correct response: when the reponse equals the category of the target word?
					{
						...
						actions: [
							...
							{type:'removeInput',handle:[targetCats.leftAttTargets.name,targetCats.rightAttTargets.name, 'targetOut']},//only one response is possible
